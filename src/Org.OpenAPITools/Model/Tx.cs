...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Tx : IEquatable<Tx>
    {
        /// <summary>
        ...
        public Tx(double type = default(double), double chainId = default(double), string data = default(string), string gas = default(string), string gasPrice = default(string), string gasTipCap = default(string), string gasFeeCap = default(string), string value = default(string), double nonce = default(double), string from = default(string), string to = default(string), string blobGas = default(string), string blobGasFeeCap = default(string), List<string> blobHashes = default(List<string>), string v = default(string), string r = default(string), string s = default(string))
        {
            this.Type = type;
