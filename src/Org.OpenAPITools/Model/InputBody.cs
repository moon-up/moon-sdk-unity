...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InputBody : IEquatable<InputBody>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as InputBody);
        }

        /// <summary>
        /// Returns true if InputBody instances are equal
        /// </summary>
        /// <param name="input">Instance of InputBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InputBody input)
        {
            if (input == null)
            {
                return false;
