...
namespace Org.OpenAPITools.Model
{
    ...
    /// Erc1155Request
    /// </summary>
    [DataContract(Name = "Erc1155Request")]
    public partial class Erc1155Request : IEquatable<Erc1155Request>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Erc1155Request" /> class.
        /// </summary>
        ...
        public Erc1155Request(string to = default(string), string data = default(string), string input = default(string), string value = default(string), string nonce = default(string), string gas = default(string), string gasPrice = default(string), string chainId = default(string), string encoding = default(string), bool eOA = default(bool), string contractAddress = default(string), string tokenId = default(string), string tokenIds = default(string), bool approved = default(bool), bool broadcast = default(bool))
        {
            this.To = to;
            this.Data = data;
            this.Input = input;
        ...
        {
            return this.Equals(input as Erc1155Request);
        }

        /// <summary>
        /// Returns true if Erc1155Request instances are equal
        /// </summary>
        /// <param name="input">Instance of Erc1155Request to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Erc1155Request input)
        {
            if (input == null)
            {
                return false;
