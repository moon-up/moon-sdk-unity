...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SolanaTransactionInput : IEquatable<SolanaTransactionInput>, IValidatableObject
    {
        ...
        public SolanaTransactionInput(string to = default(string), double value = default(double), string network = default(string), bool compress = default(bool))
        {
            this.To = to;
            this.Value = value;
        ...
        {
            return this.Equals(input as SolanaTransactionInput);
        }

        /// <summary>
        /// Returns true if SolanaTransactionInput instances are equal
        /// </summary>
        /// <param name="input">Instance of SolanaTransactionInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SolanaTransactionInput input)
        {
            if (input == null)
            {
                return false;
