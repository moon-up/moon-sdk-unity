...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class BitcoinInput : IEquatable<BitcoinInput>, IValidatableObject
    {
        /// <summary>
        ...
        public BitcoinInput(string network = default(string), string privateKey = default(string))
        {
