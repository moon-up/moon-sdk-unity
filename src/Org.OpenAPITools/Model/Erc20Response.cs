...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Erc20Response : IEquatable<Erc20Response>, IValidatableObject
    {
        ...
        public Erc20Response(double type = default(double), double chainId = default(double), string data = default(string), string gas = default(string), string gasPrice = default(string), string gasTipCap = default(string), string gasFeeCap = default(string), string value = default(string), double nonce = default(double), string from = default(string), string to = default(string), string blobGas = default(string), string blobGasFeeCap = default(string), List<string> blobHashes = default(List<string>), string v = default(string), string r = default(string), string s = default(string), string name = default(string), string symbol = default(string), string decimals = default(string), string totalSupply = default(string), string contractAddress = default(string), string balanceOf = default(string), string allowance = default(string))
        {
            this.Type = type;
