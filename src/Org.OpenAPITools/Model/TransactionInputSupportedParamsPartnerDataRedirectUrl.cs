...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class TransactionInputSupportedParamsPartnerDataRedirectUrl : IEquatable<TransactionInputSupportedParamsPartnerDataRedirectUrl>, IValidatableObject
    {
        /// <summary>
