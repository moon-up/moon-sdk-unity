...
namespace com.usemoon.MoonSDK.Api
{
    ...
    public partial class Erc4337Api : IDisposable, IErc4337Api
    {
        ...
        /// <returns></returns>
        public Erc4337Api(com.usemoon.MoonSDK.Client.Configuration configuration)
        {
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public Erc4337Api(com.usemoon.MoonSDK.Client.ISynchronousClient client, com.usemoon.MoonSDK.Client.IAsynchronousClient asyncClient, com.usemoon.MoonSDK.Client.IReadableConfiguration configuration)
        {
        ...
        public com.usemoon.MoonSDK.Client.ApiResponse<AccountAPIResponse> GetAddressWithHttpInfo(string authorization, string accountName, InputBody inputBody)
        {
            ...
            if (authorization == null)
                throw new com.usemoon.MoonSDK.Client.ApiException(400, "Missing required parameter 'authorization' when calling Erc4337Api->GetAddress");

            // verify the required parameter 'accountName' is set
            if (accountName == null)
                throw new com.usemoon.MoonSDK.Client.ApiException(400, "Missing required parameter 'accountName' when calling Erc4337Api->GetAddress");

            // verify the required parameter 'inputBody' is set
            if (inputBody == null)
                throw new com.usemoon.MoonSDK.Client.ApiException(400, "Missing required parameter 'inputBody' when calling Erc4337Api->GetAddress");
        ...
        public com.usemoon.MoonSDK.Client.ApiResponse<TransactionAPIResponse> SignBroadcastUserOpTxWithHttpInfo(string authorization, string accountName, InputBody inputBody)
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
                throw new com.usemoon.MoonSDK.Client.ApiException(400, "Missing required parameter 'authorization' when calling Erc4337Api->SignBroadcastUserOpTx");

            // verify the required parameter 'accountName' is set
            if (accountName == null)
                throw new com.usemoon.MoonSDK.Client.ApiException(400, "Missing required parameter 'accountName' when calling Erc4337Api->SignBroadcastUserOpTx");

            // verify the required parameter 'inputBody' is set
            if (inputBody == null)
                throw new com.usemoon.MoonSDK.Client.ApiException(400, "Missing required parameter 'inputBody' when calling Erc4337Api->SignBroadcastUserOpTx");
