...
namespace com.usemoon.MoonSDK.Api
{
    ...
    public partial class ENSApi : IDisposable, IENSApi
    {
        ...
        /// <returns></returns>
        public ENSApi(com.usemoon.MoonSDK.Client.Configuration configuration)
        {
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public ENSApi(com.usemoon.MoonSDK.Client.ISynchronousClient client, com.usemoon.MoonSDK.Client.IAsynchronousClient asyncClient, com.usemoon.MoonSDK.Client.IReadableConfiguration configuration)
        {
        ...
        public com.usemoon.MoonSDK.Client.ApiResponse<EnsResolveAPIResponse> ResolveWithHttpInfo(string authorization, EnsResolveInput ensResolveInput)
        {
            ...
            if (authorization == null)
                throw new com.usemoon.MoonSDK.Client.ApiException(400, "Missing required parameter 'authorization' when calling ENSApi->Resolve");

            // verify the required parameter 'ensResolveInput' is set
            if (ensResolveInput == null)
                throw new com.usemoon.MoonSDK.Client.ApiException(400, "Missing required parameter 'ensResolveInput' when calling ENSApi->Resolve");
