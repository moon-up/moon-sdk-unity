...
namespace com.usemoon.MoonSDK.Model
{
    ...
    public partial class AccountAPIResponse
    {
        /// <summary>
        ...
        public AccountAPIResponse(bool success = default(bool), string message = default(string), AccountResponse data = default(AccountResponse))
        {
